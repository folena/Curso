package com.Curso.Curso.repository.test;
...
public class AlunoRepositoryTest {
    ...
    public void testSaveAndFindAluno() {
        ...
        assertThat(retrievedAluno.get().getNota()).isEqualTo(8.0);
        assertThat(retrievedAluno.get().getEndereco().getCidade()).isEqualTo("São Paulo");
        assertThat(retrievedAluno.get().getEndereco().getEstado()).isEqualTo("SP");
        assertThat(retrievedAluno.get().getEndereco().getCep()).isEqualTo("01000-000");
    }
